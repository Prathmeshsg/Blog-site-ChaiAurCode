    ...
    return (
        <div className="p-2 w-full">
            <div className="w-full flex flex-wrap justify-center shadow-sm rounded-lg">
                <Link to={`/post/${$id}`} className="flex flex-col bg-green-100 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out w-full sm:w-80 hover:bg-gray-200">
