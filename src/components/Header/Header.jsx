            ...
            <header>
                <Container>
                    <nav className="w-full h-16 flex justify-between px-2 md:px-4 items-center">
                        <div className="mx-0 text-3xl font-bold text-green-200
                        ">
                            <Link to="/">
                                <video
                                    src={logoVideo}
                        ...
                        <ul className="md:flex hidden font-semibold text-2xl">
                            {navItems.map((item) =>
                                item.active ? (
                                    <li key={item.name} className="mt-2 mx-[20px] text-3xl cursor-pointer text-green-200 hover:text-gray-300">
